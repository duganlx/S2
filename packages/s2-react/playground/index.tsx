                              ...
                              <>
                                ...
                                <Space className="filter-container">
                                  ...
                                  <Switch
                                    ...
                                    disabled={
                                      !mergedOptions.seriesNumber?.enable
                                    }
                                  />
                                  <Switch
                                    checkedChildren="分页"
                                  ...
                                  <Tooltip title="将列头高度设为0">
                                    <Switch
                                      ...
                                      checked={
                                        mergedOptions.style?.colCell?.height ===
                                        0
                                      }
                                      onChange={(checked) => {
                                        updateOptions({
